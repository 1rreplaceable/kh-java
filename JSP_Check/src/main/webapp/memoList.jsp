...
<body>
	...
	<!-- 입력 화면 시작
	 저장을 했는데 ip 주소가 이상하게 보인다. localhost가 ipv6로 기본설정이 있어서 
	 ipv4버전으로 변경해야된다. localhost부분을 cmd-> ipconifg -> ipv4 주소를 
	 브라우저 주소에 고대로 작성한다. http://192.168.20.102:8090/JSP_Check/memoList.jsp
