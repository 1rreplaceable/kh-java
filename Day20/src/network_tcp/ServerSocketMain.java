...
public class ServerSocketMain {
	...
	public static void main(String[] args) {
		...
		// 연결하는 것
		// - 서버소켓과 클라이언트 소켓이 연결이 되어서 실제 서버에
		// 접근하거나 클라이언트에 접근이 성공되었다.
		// isBound()
		// - ServerSocket이 바인딩 되어 있는 지 여부를 확인

		// accept()
		// - 연결 요청을 수락
		// - 서버소켓 실행
		// - 연결 수락까지 설정된 시간만큼 blocking
		// - 하나의 서버에 두개의 클라이언트가 오게 되면
		// 먼저 들어온 클라이언트 소켓만들어서 통신할 동안 기다린다.
		// 기다리는 포트 9999
