...
<body>
	...
	<table width="1000" align="center" border="1" cellpadding="5"
		...
		<tr>
			...
			endPage = startPage +9;
			// 페이지 이동 버튼의 마지막 페이지 번호가 전체 페이지 수보다 커지면
			...
			%>
			<button type="button" disabled="disabled" title="이미 첫 페이지입니다.">처음</button>
			<%} 
			...
			for(int i = startPage; i <= endPage; i++){
				...
				<button type="button" onclick="location.href=
					'?currentPage='<%=i%>"><%=i%></button>
			<%
				}
			}
			
			// 10페이지 뒤로
			// endPage가 totalPage보다 작으면 다음 페이지로 이동할 수 있다.
